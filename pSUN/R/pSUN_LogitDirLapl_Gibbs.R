#' @title Perturbed Unified Skew Normal Logit Dirichlet-Laplace: Gibbs Sampler
...
#' @import statmod
#' @export
pSUN_LogitDirLapl_Gibbs = function(
  nsim, A, b, xi, Omega,
  ...
  if (!is.infinite(verbose)) {
    print(paste(
      "pSUN_LogitDirLapl_Gibbs: start time at ", Sys.time(), sep = ""
    ))
  }
  ...
  if (!is.infinite(verbose)) {
    print(paste("pSUN_LogitDirLapl_Gibbs: end time at ", Sys.time(), sep = ""))
  }
